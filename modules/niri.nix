...
let
  ...
  niriConfig = {
    ...
    input =
      ...
      // (
        if cfg.focusFollowsMouseMaxScrollAmount != null
        then {
          "focus-follows-mouse" = {
    ...
    layout =
      ...
      // lib.optionalAttrs (cfg.focusRingWidth != 4) {
        ...
        "focus-ring" = { width = cfg.focusRingWidth; };
      };
    ...
    binds =
      {
        ...
        "XF86MonBrightnessUp" = {
          _props."allow-when-locked" = true;
          spawn._args = [ "brightnessctl" "--class=backlight" "set" "+10%" ];
        };
      ...
      // lib.listToAttrs (
        lib.genList (i: let n = i + 1; in {
          name = "Mod+${toString n}";
          value = { "focus-workspace"._args = [ n ]; };
        }) 9
      )
      // lib.listToAttrs (
        lib.genList (i: let n = i + 1; in {
          name = "Mod+Ctrl+${toString n}";
          value = { "move-column-to-workspace"._args = [ n ]; };
        }) 9
      );
